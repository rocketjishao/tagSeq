...
|5| featureCounts | ADPRC+_tagged.sam; ADPRC+_untagged.sam; ADPRC-_tagged.sam; ADPRC-_untagged.sam; annotation file ([TAIR10.gff](https://www.arabidopsis.org/download_files/Genes/TAIR10_genome_release/TAIR10_gff3/TAIR10_GFF3_genes.gff)) | all; all.summary |[demo](https://github.com/rocketjishao/NAD-tagSeq/blob/Arabidopsis-only/Demo-featureCounts.tar.xz)|  
